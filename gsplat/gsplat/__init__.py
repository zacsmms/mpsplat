...
# Importing the `mps` subpackage triggers `register_metal_kernel(...)` for
# every op whose Metal shader is available, so the dispatcher in
# `gsplat.cuda._wrapper` automatically routes MPS tensors to native kernels.
from . import mps as _mps_pkg  # noqa: F401
